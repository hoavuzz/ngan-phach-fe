...
export class OrderService {
  ...
  // Gửi đánh giá sản phẩm từ đơn hàng đã hoàn thành
  submitReview(payload: { chitietdonhang_id: number; soSao: number; nhanXet?: string }): Observable<any> {
    return this.http.post('http://localhost:3000/api/danhgia', payload);
  }
}
